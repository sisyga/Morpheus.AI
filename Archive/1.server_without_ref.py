...
def pdf_to_morpheus_pipeline(pdf_path: str) -> Dict[str, Any]:
    ...
    return {
        ...
        "message": (
            ...
            "No reference models are used in this baseline configuration."
        ),
    }
...
def run_full_pipeline(
    ...
    PDF → XML save → Morpheus run → evaluation (ALWAYS)
    """
